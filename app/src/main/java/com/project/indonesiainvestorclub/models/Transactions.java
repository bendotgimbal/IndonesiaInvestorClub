...
public class Transactions {
  ...
  private final static String NEED_UPLOAD = "Not Upload";
  private final static String ALREADY_UPLOAD = "Done Upload";
  private final static String ALREADY_CONFRIMED = "Confirm Upload";

  int index;

  public Transactions(String name, String invest_date, String invest_usd, String invest_idr,
      String dp_date, String dp_amount,
      String dp_id, String dp_status, String dp_proof, String start_date, String end_date,
      String status,
      String wd_date, String wd_amount, String wd_id, String wd_status, String wd_start,
      String wd_end) {
    this.name = name;
