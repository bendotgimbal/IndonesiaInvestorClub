...
import com.project.indonesiainvestorclub.models.Current;
...
//            InvestRes investRes;
            ...
            ParticipantInvestPrevious participantInvestPrevious = new ParticipantInvestPrevious(participantPreviousDate, participantPreviousInvest);
...
//            Current current = new Current(currentDatalist);
            ParticipantInvestCurrent participantInvestCurrent = new ParticipantInvestCurrent(currentDatalist);
            ParticipantInvest participantInvest = new ParticipantInvest(participantInvestPrevious,participantInvestCurrent);
...
//        investNameTx.set(investRes.getPerformanceInvest().getClass().getName());
//        yearPerformancesValueTv.set("2020");
//        ytdPerformancesValueTv.set("10%");
